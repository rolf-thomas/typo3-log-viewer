...
echo "Please determine the changes from the git log between the last release"
echo "and the current status and update the CHANGELOG.md with a concise list"
echo "of the changes that have been made."
echo ""
